...
print("-------------------------")
print(f"Khan: {khan_percentage:.2%} ({khan_votes})")
print(f"Correy: {correy_percentage:.2%} ({correy_votes})")
print(f"Li: {li_percentage:.2%} ({li_votes})")
print(f"O'Tooley {otooley_percentage:.2%} ({otooley_votes})")
